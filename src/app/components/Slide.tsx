...
const Slide: React.FC<propsType> = ({ img, title, mainTitle, price }) => {
  return (
    <div className="outline-none border-none relative">
      ...
      >
        <h3 className="text-accent text-[24px] lg:text-[280x]">{title}</h3>
      ...
      <img className="w-[100%] h-[300px] md:h-auto rounded-x1 object-cover object-right md:object-left-button"
      src={img}
      alt="banner"
      width={2000}
      height={2000}
